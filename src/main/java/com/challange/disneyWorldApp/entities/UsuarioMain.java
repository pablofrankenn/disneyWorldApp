...
public class UsuarioMain implements UserDetails {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1855116196494340061L;
	...
	public static UsuarioMain build(Usuario usuario) {
		...
		return new UsuarioMain(usuario.getNombre(), usuario.getUsuario(), usuario.getEmail(), usuario.getPassword(),
				authorities);
	}
